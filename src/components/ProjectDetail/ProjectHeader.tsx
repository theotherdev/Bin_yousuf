...
export const ProjectHeader: React.FC<ProjectHeaderProps> = ({ 
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-[10px] 
...
export const ProjectGallery: React.FC<ProjectGalleryProps> = ({ images, projectName }) => {
    ...
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1400px] mx-auto px-10 text-center">
          <p className="text-clamp-description font-normal leading-[1.4] 
