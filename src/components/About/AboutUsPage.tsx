          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <div className="space-y-6 text-lg text-neutral-700 leading-relaxed">
                <p>
                  ...
                  As the <strong className="text-[#4c4c4c]">official sales partners</strong> of HMR Waterfront and Emaar Oceanfront, 
              ...
              <div className="mt-12">
                <button 
                  ...
                  className="inline-flex items-center gap-3 bg-gradient-to-r from-[#4c4c4c] to-neutral-600 hover:from-neutral-600 hover:to-[#4c4c4c] text-white px-8 py-4 rounded-none font-semibold transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
                >
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-8 mb-12">
                ...
                <div className="text-center p-6 bg-neutral-50 rounded-none hover:bg-neutral-100 transition-colors duration-300">
                  <div className="text-4xl font-semibold text-[#4c4c4c] mb-2">10+</div>
                  <div className="text-sm font-medium text-neutral-600 uppercase tracking-wide">
                    Years Experience
                  </div>
                </div>
                ...
                <div className="text-center p-6 bg-neutral-50 rounded-none hover:bg-neutral-100 transition-colors duration-300">
                  <div className="text-4xl font-semibold text-[#4c4c4c] mb-2">2</div>
                  <div className="text-sm font-medium text-neutral-600 uppercase tracking-wide">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-semibold text-[#4c4c4c] mb-6">Our Expertise</h3>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#4c4c4c] mb-1">Official Sales Partners</h4>
                    <p className="text-neutral-600">Authorized partnerships with premium waterfront developers</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#4c4c4c] mb-1">Luxury Oceanfront Properties</h4>
                    <p className="text-neutral-600">Specialized in premium sea-facing residential developments</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#4c4c4c] mb-1">Investment Guidance</h4>
                    <p className="text-neutral-600">Strategic market insights and investment consultation</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#4c4c4c] mb-1">End-to-End Service</h4>
                    <p className="text-neutral-600">Complete transaction management from selection to handover</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-neutral-600 font-medium">Official Sales Partner</p>
                </div>
              </div>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-neutral-600">Sea-facing luxury apartments</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-neutral-600 rounded-full"></div>
                  <span className="text-neutral-600">World-class amenities</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-neutral-600 rounded-full"></div>
                  <span className="text-neutral-600">Premium DHA Phase 8 location</span>
                </div>
              </div>
            ...
            >
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-neutral-600 rounded-full"></div>
                  <span className="text-neutral-600">Waterfront residences</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-neutral-600 rounded-full"></div>
                  <span className="text-neutral-600">Modern architectural design</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-neutral-600 rounded-full"></div>
                  <span className="text-neutral-600">Comprehensive lifestyle amenities</span>
                </div>
              </div>
