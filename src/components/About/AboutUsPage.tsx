...
const AboutUsPage: React.FC = () => {
  ...
  return (
    <main className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <div className="mt-12">
                <button 
                  ...
                  className="inline-flex items-center gap-3 bg-gradient-to-r from-[#4c4c4c] to-gray-600 hover:from-gray-600 hover:to-[#4c4c4c] text-white px-8 py-4 rounded-none font-semibold transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
                >
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-8 mb-12">
                <div className="text-center p-6 bg-gray-50 rounded-none hover:bg-gray-100 transition-colors duration-300">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4 group">
                  <div className="w-6 h-6 bg-[#4c4c4c] rounded-full flex items-center justify-center flex-shrink-0 mt-1 group-hover:bg-gray-600 transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 bg-white rounded-none flex items-center justify-center mr-4 shadow-lg border border-gray-100 p-2">
                  <img 
                    src={emaarLogo.src} 
                    alt="Emaar Logo" 
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 text-gray-700 font-medium hover:text-gray-900 transition-colors duration-300 group"
              >
                View Emaar Projects
      ...
      <section className="relative py-24 bg-gradient-to-br from-[#4c4c4c] via-gray-700 to-gray-800 overflow-hidden">
        {/* Background Pattern */}
