...
const Footer: React.FC = () => {
  ...
  return (
    <>
      ...
      <footer className="relative w-full bg-black py-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div className="lg:col-span-1">
              ...
              <button 
                ...
                className="inline-flex items-center gap-3 bg-white hover:bg-gray-100 text-black px-6 py-3 rounded-lg font-medium transition-all duration-300 hover:-translate-y-1 hover:shadow-lg group mb-6"
              >
