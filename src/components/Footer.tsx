...
const Footer: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="w-full h-px bg-gradient-to-r from-transparent via-neutral-300 to-transparent"></div>
      
      <footer className="relative w-full bg-gradient-to-br from-neutral-800 via-neutral-900 to-black py-16">
            ...
            <div>
              ...
              <nav className="space-y-4">
                <a 
                  ...
                  className="block text-neutral-300 hover:text-blue-400 transition-colors duration-300 text-sm hover:translate-x-1 transform"
                >
                  LinkedIn
                </a>
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="block text-neutral-300 hover:text-pink-400 transition-colors duration-300 text-sm hover:translate-x-1 transform"
                >
                  Instagram
                </a>
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="block text-neutral-300 hover:text-blue-500 transition-colors duration-300 text-sm hover:translate-x-1 transform"
                >
                  Facebook
                </a>
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="block text-neutral-300 hover:text-red-500 transition-colors duration-300 text-sm hover:translate-x-1 transform"
                >
                  YouTube
                </a>
                <a 
                  href="mailto:info@binyousufgroup.com"
                  className="block text-neutral-300 hover:text-green-400 transition-colors duration-300 text-sm hover:translate-x-1 transform"
                >
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
              ...
              <div className="flex gap-4">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-neutral-400 hover:text-blue-400 transition-all duration-300 p-2 rounded-none hover:bg-blue-400/10 hover:scale-110 transform"
                >
                ...
                <a href="https://www.instagram.com/binyousuf.group" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-neutral-400 hover:text-pink-400 transition-all duration-300 p-2 rounded-none hover:bg-pink-400/10 hover:scale-110 transform"
                >
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path
                      fillRule="evenodd"
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-neutral-400 hover:text-red-400 transition-all duration-300 p-2 rounded-none hover:bg-red-400/10 hover:scale-110 transform"
                >
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
