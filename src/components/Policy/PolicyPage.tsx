            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">Request access to and correction of your personal information</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">Request deletion of your personal information (subject to legal requirements)</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">Unsubscribe from marketing communications at any time</p>
                </div>
              </div>
            </div>
          </div>
